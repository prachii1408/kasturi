  ...
  return (
    <Box bg={"brand.primary"} p="1rem">
        ...
        < Flex display="flex" justifyContent={"space-between"} >
          <Box>
            <Heading as="h5" textColor={"brand.primaryDark"} mt="3rem" ml="10vw"fontFamily={"Baskervville"} fontWeight={"medium"} fontSize={{base:"1.4rem",md:"1.6rem",lg:"2.2rem"}}>JEWELLERY CARE GUIDE</Heading>
     ...
     < Flex display="flex" justifyContent={"space-between"} >
     <Image src="guide_model2.png" w={{base:"10rem",md:"14rem",lg:"20rem"}} h={{base:"14rem",md:"16rem",lg:"22rem"}}ml="10vw" alt="model2" ></Image>
          <Box>

            <Text w="30vw" textColor="brand.primaryDark" fontFamily={"Baskervville"} fontStyle={"italic"} fontSize={{base:"1.3rem",md:"2rem",lg:"2.5rem"}} mt={{base:"1rem",md:"1.2rem",lg:"1.7rem"}}>Your Jewellery Collection deserves 
